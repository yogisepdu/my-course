        ...
        <div class="row">
            <div class="col-md-6 mb-5">
                <a href="{{ route('index') }}" class="navbar-brand">
                    <h1 class="mt-n2 text-uppercase text-white"><img src="{{ asset('assets/images/Logo.png') }}"
                            alt="Image" style="width: 150px;"></img>Dev
                        Coding Lab</h1>
                </a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0">Copyright &copy; <a class="text-white" href="#">Dev Coding Lab</a>. All
                    Rights Reserved.
                </p>
            </div>
            <div class="col-md-6 text-center text-md-right">
                <p class="m-0">Designed by <a class="text-white" href="#">Dev Coding Lab</a>
                    Distributed by <a href="#" target="_blank">Yogi Sepdu Dehiya</a></p>
            </div>
        </div>
    </div>
</div>
