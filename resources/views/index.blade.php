        ...
        <div class="owl-carousel courses-carousel">
            @forelse ($courses as $data)
                <div class="courses-item position-relative">
                    <img class="img-fluid" src="{{ asset('storage/' . $data->thumbnail) }}" alt="{{ $data->title }}"
                        style="height: 350px; object-fit: cover;">
                    <div class="courses-text">
                        <h4 class="text-center text-white px-3">{{ \Illuminate\Support\Str::title($data->title) }}</h4>
                        <div class="border-top w-100 mt-3">
                            <div class="d-flex justify-content-between p-4">
                                <span class="text-white"><i
                                        class="fa fa-user mr-2"></i>{{ $data->instructor->name ?? '-' }}</span>
                                <span class="text-white"><i class="fa fa-star mr-2"></i>4.5 <small>(250)</small></span>
                            </div>
                        </div>
                        <div class="w-100 bg-white text-center p-4">
                            <a class="btn btn-primary" href="{{ $data->detail_url ?? '#' }}">Course Detail</a>
                        </div>
                    </div>
                </div>
            @empty
                    ...
                    <div class="team-item">
                        ...
                        <div class="bg-light text-center p-4">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <a class="mx-1 p-1" href="{{ $data->links_facebook }}"><i
                                        class="fab fa-facebook-f"></i></a>
                                <a class="mx-1 p-1" href="{{ $data->links_linkedin }}"><i
                                        class="fab fa-linkedin-in"></i></a>
                                <a class="mx-1 p-1" href="{{ $data->links_instagram }}"><i
                            ...
                            <div class="bg-white p-5">
                                ...
                                <div class="d-flex flex-shrink-0 align-items-center mt-4">
                                    <img class="img-fluid mr-4"
                                        src="{{ asset('storage') . '/' . $testi->profile_picture }}"
                                        alt="{{ $testi->name }}"
