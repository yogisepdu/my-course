                        ...
                        <div class=" d-flex flex-wrap gap-2 justify-content-between align-items-center">
                            ...
                            <div class="card-header">
                                <a class="btn btn-primary" role="button"
                                    href="{{ route('admin.instructor.create') }}">Create
                                    Instructor</a>
                            </div>
                        </div>
                        <!-- [ link-button ] end -->
                                    ...
                                    <tbody>
                                        @foreach ($instructors as $data)
                                            <tr>
                                                ...
                                                <td class="text-wrap">{{ $data->user->name ?? '' }}</td>
                                                ...
                                                <td class="text-wrap">{{ $data->links_twitter ?? '' }}</td>
                                                <td class="text-wrap">{{ $data->links_linkedin ?? '' }}</td>
                                                <td class="text-wrap">{{ $data->links_facebook ?? '' }}</td>
                                                <td class="text-wrap">{{ $data->links_instagram ?? '' }}</td>
                                                <td class="text-wrap">{{ $data->links_youtube ?? '' }}</td>
                                                <td class="text-wrap card-body pc-component">
                                                    <a type="button" class="btn btn-light-primary"
                                                        href="{{ route('admin.instructor.edit', $data->id) }}">Edit</a>
                                                    <a type="button" class="btn btn-light-danger"
                                                        href="{{ route('admin.instructor.destroy', $data->id) }}">Hapus</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
