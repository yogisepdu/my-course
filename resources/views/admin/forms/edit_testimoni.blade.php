                    ...
                    <div class="card">
                        ...
                        <form action="{{ route('admin.testimoni.update', $testimoni->id) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="job" id="jobTestimoni"
                                        ...
                                        value="{{ old('job', $testimoni->job) }}" required>
                                    @error('job')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="description" id="descriptionTestimoni" class="form-control @error('description') is-invalid @enderror"
                                        rows="3" placeholder="Enter description" required>{{ old('description', $testimoni->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    @if ($testimoni->profile_picture)
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/' . $testimoni->profile_picture) }}"
                                                alt="Profile Picture" width="100" class="rounded">
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('admin.testimoni.index') }}" class="btn btn-light">Cancel</a>
                            </div>
                        </form>
                    </div>
                    <!-- [ form-element ] end -->
