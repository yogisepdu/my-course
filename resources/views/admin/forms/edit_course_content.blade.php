            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <form action="{{ route('admin.ecourse.content.update', $content->id) }}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="section_id" id="section_id"
                                        ...
                                        <option value="" disabled
                                            {{ old('section_id', $content->section_id ?? '') == '' ? 'selected' : '' }}>
                                            -- Select Section --
                                        </option>
                                        @foreach ($section as $sec)
                                            <option value="{{ $sec->id }}"
                                                {{ old('section_id', $content->section_id ?? '') == $sec->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="content_type" id="content_type"
                                        ...
                                        <option value="" disabled
                                            {{ old('content_type', $content->content_type ?? '') == '' ? 'selected' : '' }}>
                                            -- Select Type --
                                        </option>
                                        <option value="video"
                                            {{ old('content_type', $content->content_type ?? '') == 'video' ? 'selected' : '' }}>
                                            Video</option>
                                        <option value="pdf"
                                            {{ old('content_type', $content->content_type ?? '') == 'pdf' ? 'selected' : '' }}>
                                            PDF</option>
                                        <option value="text"
                                            {{ old('content_type', $content->content_type ?? '') == 'text' ? 'selected' : '' }}>
                                            Text</option>
                                    </select>
                                    @error('content_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="url" name="content_url" id="content_url"
                                        ...
                                        placeholder="Enter content URL (if any)"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="body" id="body" rows="4" class="form-control @error('body') is-invalid @enderror"
                                        placeholder="Enter text content (optional)">{{ old('body', $content->body ?? '') }}</textarea>
                                    @error('body')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="order" id="order"
                                        ...
                                        placeholder="Enter order number" value="{{ old('order', $content->order ?? 0) }}"
                                        required>
                                    @error('order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
